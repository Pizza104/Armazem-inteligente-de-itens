...
<div class="card shadow mt-3">
    <form method="post" class="m-3">
        <?php if ($mensagem): ?>
            <div class="alert alert-<?= $erro ? 'danger' : 'success' ?>"><?= htmlspecialchars($mensagem) ?></div>
        <?php endif; ?>

        <div class="form-group row">
            <label for="txtnome" class="col-sm-2 col-form-label">Nome</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="txtnome" name="txtnome" required value="<?= htmlspecialchars($_POST['txtnome'] ?? '') ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="email" class="form-control" id="txtemail" name="txtemail" required value="<?= htmlspecialchars($_POST['txtemail'] ?? '') ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="txttelefone" name="txttelefone" placeholder="(00) 00000-0000" value="<?= htmlspecialchars($_POST['txttelefone'] ?? '') ?>">
            </div>
        </div>
